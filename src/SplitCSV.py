...
in_csv = '/home/steven/Documents/UdeA/maestria/Tesis/Implementación/'\
        'my_project/my_environment/code/implementation/features/flow_0.csv'
...
for i in range(1, number_lines, rowsize):  # 1, max_size, 1):
    ...
    out_csv = '/home/steven/Documents/UdeA/maestria/Tesis/Implementación/'\
        'my_project/my_environment/code/implementation/features/flow_'\
        + str(j) + '.csv'
